...
=======
    console.log('Đã kết nối cơ sở dữ liệu PostgreSQL (Cloud).');
...
=======
            console.log('Đã kết nối cơ sở dữ liệu SQLite (Local).');
>>>>>>> 088ffd02b81eda318d52f5ce5c52792b13e7040b
            initDb();
        }
    });
...
=======
                const mockThis = { lastID: res && res.rows.length > 0 ? res.rows[0].id : null };
>>>>>>> 088ffd02b81eda318d52f5ce5c52792b13e7040b
...
function initDb() {
    ...
    const submissionTable = isPostgres
        ? `CREATE TABLE IF NOT EXISTS submissions (id SERIAL PRIMARY KEY, student_id INTEGER, type TEXT, file_path TEXT, stars INTEGER, comment TEXT, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)`
        : `CREATE TABLE IF NOT EXISTS submissions (id INTEGER PRIMARY KEY AUTOINCREMENT, student_id INTEGER, type TEXT, file_path TEXT, stars INTEGER, comment TEXT, created_at DATETIME DEFAULT CURRENT_TIMESTAMP)`;
